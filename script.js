...
// const veryOldInventors = inventors.year.filter( (year1) => {
//     return (year>= 1500 &&  year<= 1599);
...
// Enter your solution code here:
const inventorNames = inventors.map((inventor1) => {
return (`{first: ${inventor1.first} , last: ${inventor1.last}}`)
...
// Enter your solution code here:
let firstLast = people.map((FirstLast) =>{
    return 
